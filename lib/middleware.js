  ...
  return function (next) {
    return function () {
      var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(action) {
        var requestOptions, entrypoint, types, auth, json, body, formData, method, onSuccess, onFailed, urlEncoded, dispatchPayload, _types, successType, errorType, requestType, fetchOptions, token, response;
            ...
            switch (_context.prev = _context.next) {
              ...
              case 14:
                ...
                if (urlEncoded) {
                  ...
                  fetchOptions.body = _querystring2.default.stringify(body || {});
                }
